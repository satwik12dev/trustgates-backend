...
const adminCriticalActionRateLimiter = async (
    req,
    res,
    next
) => {
    ...
    try {
        ...
        const ipKey =
            `rl:admin:critical:ip:${normalizedIp}`;

        const adminKey =
            `rl:admin:critical:admin:${adminId}`;
        ...
        if (
            ...
            return res
                ...
                .json({
                    ...
                    code:
                        "ADMIN_CRITICAL_RATE_LIMIT_EXCEEDED",

                    message:
                        "Too many critical admin requests. Please try again later.",
        ...
        console.error(
            "Admin Critical Rate Limiter Error:",
            error.message
        );
