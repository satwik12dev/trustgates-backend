...
const adminSensitiveActionRateLimiter = async (
    req,
    res,
    next
) => {
    ...
    try {
        ...
        const ipKey =
            `rl:admin:sensitive:ip:${normalizedIp}`;

        const adminKey =
            `rl:admin:sensitive:admin:${adminId}`;
        ...
        if (
            ...
            return res
                ...
                .json({
                    ...
                    code:
                        "ADMIN_SENSITIVE_RATE_LIMIT_EXCEEDED",
        ...
        console.error(
            "Admin Sensitive Rate Limiter Error:",
            error.message
        );
