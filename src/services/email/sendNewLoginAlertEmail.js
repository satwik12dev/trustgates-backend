...
const sendNewLoginAlertEmail = async (
    merchantName,
    email,
    details = {}
) => {
    ...
    const device = details.userAgent || details.device || "Unknown Device";
    ...
    await transporter.sendMail({
        ...
        subject: "Security Alert: New Sign-in to Your Account - Trust Gates",
                        ...
                        <table width="600" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:32px;color:#333333;line-height:1.7;">
                                    ...
                                    <p>
                                        We detected a new sign-in to your <strong>Trust Gates</strong> merchant account with the following details:
                                    </p>
                                    ...
                                    <div style="background:#FFF8E1;border-left:4px solid #F59E0B;padding:16px;margin:24px 0;">
                                        <strong style="color:#92400E;">Don't recognize this activity?</strong>
                                        <p style="margin:8px 0 0;font-size:14px;color:#92400E;">
                                            If you did not sign in at this time, please reset your password immediately and contact Trust Gates support.
                                        </p>
                                    </div>
...
module.exports = sendNewLoginAlertEmail;
